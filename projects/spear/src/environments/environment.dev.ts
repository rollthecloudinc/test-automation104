...
export const environment = {
  production: false,
  site: 'test-automation104',
  apiGatewaySettings: {
    // endpointUrl: 'https://localhost:44340',
    endpointUrl: "https://vertigo.druidcloud.dev/rollthecloudinc/test-automation104-objects/shapeshifter"
  },
  mediaSettings: {
    endpointUrl: 'https://vertigo.druidcloud.dev/test-automation104/media',
    cloudinaryUrl: 'https://api.cloudinary.com/v1_1/dj4vvkgzw',
    uploadPreset: 'i0hm4opm',
    imageUrl: 'https://vertigo.druidcloud.dev/test-automation104',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/test-automation104-objects'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-dev-eldczuhq3vesgpjnr3vie6cagq'
  },
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://test-automation104.druidcloud.dev/auth-callback',
    silent_redirect_uri: 'https://test-automation104.druidcloud.dev/silent-refresh.html',
    response_type: "code",
